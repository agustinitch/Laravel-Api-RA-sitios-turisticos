    ...
    <style>
        ...
        *,
        ...
        .btn-continuar{
            ...
            display: block;
            margin: auto;
            background-color: #2fd0f4;
            max-width: 140px;
            padding: 20px;
            border: 1px solid #2fd0f4;
            color: #fff;
            border-radius: 35px;
        }
        .btn-continuar:hover{
...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="hidden px-6 py-4 sm:block" style="padding: 60px; background-color: #fff; border: 1px solid #fff; border-radius: 35px;">
            ...
            <h2 style="font-size: 36px; margin: 0px 0 50px 0px;">Bienvenido</h2>

            <a href="{{ route('login') }}" class="btn-welcome">Log in</a>
